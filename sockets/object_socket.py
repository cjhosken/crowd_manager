...
class CrowdManager_ObjectSocket(NodeSocket):
	...
	bl_idname = 'CrowdManager_ObjectSocketType'		# Optional identifier string. If not explicitly defined, the python class name is used.
	bl_label = 'Object Socket'				# Label for nice name display
